...
<p align="center">
  <img src="https://img.shields.io/badge/Version-1.5.7-0078d4?style=for-the-badge&logo=github" alt="Version">
...
### Новые функции (v1.5.7)
- **Полный редизайн настроек**: Чистый iOS-подобный интерфейс с переключателями вместо галочек.
- **Магнитные направляющие (Snap Guides)**: Идеально ровное перетаскивание оверлея по сетке с подсветкой осей (для нескольких мониторов).
- **Стабилизация тем**: Исправлен черный экран на некоторых сборках Windows 10 в теме Glass.
